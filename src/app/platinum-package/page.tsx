...
function Page() {
  return (
    ...
    <Head>
        ...
        />
        <link rel="canonical" href="https://drpathcares.com/platinum-package" />
        {/* Google Tag Manager */}
        <script
      ...
      <Nav />
      <main className="">
        <BasicPackageBanner testname={"Platinum Package"} totaltest={"Includes 102 Tests"} originalprice={"₹7500"} saleprice={"₹3999"} image={"/images/Platinum-Package.jpeg"}/>
        <PlatinumPackage />
      </main>
      <Footer />
    </>
