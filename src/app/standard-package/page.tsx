...
function Page() {
  return (
    ...
    <Head>
        ...
        />
        <link rel="canonical" href="https://drpathcares.com/standard-package" />
        {/* Google Tag Manager */}
        <script
      ...
      <Nav />
      <main className="">
        <BasicPackageBanner testname={"Standard Package"} totaltest={"Includes 90 Tests"} originalprice={"₹4500"} saleprice={"₹1650"} image={"/images/Standard-Package.jpeg"}/>
        <StandardPackage />
      </main>
      <Footer />
    </>
