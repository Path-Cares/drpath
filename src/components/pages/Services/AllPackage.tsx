  ...
  return (
    <section className="px-5 lg:px-20 xl:px-24 2xl:px-72 pb-20">
      <div className="grid sm:gid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <TestView
          testname={"Classic Men Package"}
          totaltest={"95 parameters included"}
          originalprice={"₹4500"}
          saleprice={"₹2250"}
          estimatetime={"Report Within 24 Hours"}
          url={"/classic-men-package"}
        />

        <TestView
          testname={"CLASSIC WOMEN PACKAGE"}
          totaltest={"95 parameters included"}
          originalprice={"₹4500"}
          saleprice={"₹2250"}
          estimatetime={"Report Within 24 Hours"}
          url={"/classic-women-package"}
        />
        ...
        <TestView
          testname={"SENIOR CITIZENS"}
          totaltest={"86 parameters included"}
          originalprice={"₹4500"}
          saleprice={"₹1650"}
          estimatetime={"Report Within 24 Hours"}
          url={"/senior-citizens-package"}
        />
        ...
        <TestView
          ...
          saleprice={"₹1499"}
          estimatetime={"Report Within 24 Hours"}
          url={"/fever-panel-one-package"}
        />

        <TestView
          testname={"Fever Panel 2"}
          totaltest={"87 parameters included"}
          originalprice={"₹3500"}
          saleprice={"₹1499"}
          estimatetime={"Report Within 24 Hours"}
          url={"/fever-panel-two-package"}
        />
