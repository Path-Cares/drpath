...
const CtaStrip = () => {
  return (
    <section
      className=""
      style={{ backgroundImage: "url('images/cta-strip.webp')" }}
    >
        ...
        <div className="lg:flex gap-10 text-white">
          <div className="lg:w-2/3">
            ...
            <p className="">
              ...
              professionals to take care of your health.
            </p>
          </div>
          <div className="flex gap-10 lg:w-1/3 h-auto mt-4 lg:mt-0">
            <a href="tel:+919125393939">
              <button className="bg-[#00B7AB] px-6 rounded-xl h-12">
                Call Us
              </button>
            </a>
            <a href="mailto:dr.pathcare@gmail.com">
              <button className="bg-white text-[#161920] rounded-xl h-12 px-6">
                Write Us
              </button>
            </a>
          </div>
